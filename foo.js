  ...
  return {
    showRepos: function(options){
      ...
      $.getJSON("https://api.github.com/users/"+options.user+"/repos?callback=?"
        , function(response) {
          console.log(pp([].slice.call(arguments)));
          var repos = [];
